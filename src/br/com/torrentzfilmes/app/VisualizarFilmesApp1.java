...
//        }            
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        try {
           ...
           // Desktop.getDesktop().open(new File(HOME_USUARIO + File.separator + "video.mp4"));
            Desktop.getDesktop().open(new File(HOME_USUARIO + File.separator +
                    "\\Videos\\4K Video Downloader\\.mp4"));
...
//            List<Visualizado> visualizados = new ArrayList<>();
//            for (Filme filme : filmesSelecionados) {
//                Visualizado visualizado = new Visualizado();
//                visualizado.setCompleto(false);
//                visualizado.setFilme(filme);
//                visualizado.setDataVisualizacao(new Date());
//                visualizado.setUsuario(this.usuario);
//
//                visualizados.add(visualizado);
//            }
//            VisualizadoBll.adicionarTodos(visualizados);
        } catch (Exception ex) {
    ...
    private void jButtonAssistidoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAssistidoActionPerformed
        ...
        visualizadoBll.buscarPorFilmeEUsuario(visualizado);
